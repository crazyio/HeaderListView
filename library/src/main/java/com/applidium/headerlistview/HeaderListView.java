...
public class HeaderListView extends RelativeLayout {
    ...
    // TODO1: Handle listViews with fast scroll
    // TODO1: Pass ListView XML attributes to the mListView
    // TODO1: See if there are methods to dispatch to mListView
    ...
    private void init(Context context) {
        ...
        ColorDrawable menuDeviderColor = new ColorDrawable(this.getResources().getColor(R.color.menuDeviderColor));
        mListView.setDivider(menuDeviderColor);
